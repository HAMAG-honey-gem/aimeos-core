...
<section class="catalog-filter-search">
	...
	<div style="display: inline-block; position: relative; right: 25pt;" class="pp_default" onclick="document.getElementById('search_text').value='';this.previousSibling.value=' ';this.previousSibling.placeholder='<?php $this->translate( 'client/html', 'Search') ?>';this.parentNode.parentNode.submit();">
